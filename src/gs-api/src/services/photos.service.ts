...
class PhotosService extends __BaseService {
  ...
  savePhotoResponse(params: PhotosService.SavePhotoParams): __Observable<__StrictHttpResponse<{}>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock/v1/save/${encodeURIComponent(String(params.id))}/${encodeURIComponent(String(params.title))}/${encodeURIComponent(String(params.context))}`,
      __body,
      {
        headers: __headers,
        params: __params,
